        ...
        <div className="w-[90%] sm:w-[70%] mx-auto grid grid-cols-1 xl:grid-cols-2 gap-10">
            ...
            <div>
                ...
                <div className="mt-10">
                    ...
                    <ResumeCard Icon={FaReact} role="Bachelor in Computer Science" date='Jan 2019 - Dec 2022'/>
                    <ResumeCard Icon={FaDatabase} role="Cerificate Digital" date='Jan 2016 - Dec 2019'/>
                </div>
            </div>
        </div>
    </div>
